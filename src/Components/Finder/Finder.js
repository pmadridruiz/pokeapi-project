...
function Finder() {
    ...
    return (
        <>
            {/* <h1>{busqueda}</h1> */}
            <div className='pt-36'>
                <form className='items-center max-w-md mx-auto shadow rounded border-0 p-3'>
                    ...
                    <div className="relative">
                        ...
                        <input onChange={(event) => setBusqueda(event.target.value)} type="search" id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Pókemones..." required="" />
            ...
            <div className='items-center max-w-md mx-auto shadow rounded border-0 p-3'>
                ...
                {pokemon?.name && (<li key={pokemon?.id}>weight - {pokemon?.location_area_encounters.location_area}</li>)}
            </div>
