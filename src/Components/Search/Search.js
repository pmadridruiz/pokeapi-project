        ...
        <>
            <form onSubmit={handleSubmit} id='search-pokemon' onChange={(e) => setBusqueda(e.target.value)}>
                ...
                <div className="relative pt-2">
                    ...
                    <button onClick={handleSubmit} type="submit" className="block text-white absolute font-medium rounded-lg text-sm px-4 py-2 right-2.5 bottom-2.5 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Buscar</button>
                </div>
            </form>
