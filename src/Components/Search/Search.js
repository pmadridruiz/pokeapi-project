        ...
        <>
            <form onChange={(e) => setBusqueda(e.target.value)}>
                ...
                <div className="relative pt-2 ">
                    ...
                    <input onSubmit={handleKeyDown} type="text" id="default-search" className="block p-4 pl-10 w-full text-sm text-black bg-gray-50 rounded-lg border focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-300 dark:border-gray-600 dark:placeholder-black text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Pókemon..." required />
