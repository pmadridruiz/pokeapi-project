                    ...
                    <div className='md:w-64 m-2'>
                        ...
                        {!cargando && pokemon ? (
                            <div className='grid text-center justify-center'>
                                ...
                                <div className='flex items-center content-center justify-center pt-2'>
                                    <button onClick={() => attackPokemonUno('special-attack')} disabled={disableAttackUno || hpPokemonUno <= 0} type="button" className="inline-block px-6 py-2.5 bg-gray-800 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">Ataque Especial</button>
                                </div>
