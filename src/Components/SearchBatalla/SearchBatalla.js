        ...
        <>
            <form onSubmit={handleSubmit} id='search-pokemonDos' onChange={(e) => setBusquedaDos(e.target.value)}>
                ...
                <div className="relative pt-2">
                    ...
                    <input type="text" id="default-searchDos" className="block p-4 pl-10 w-full text-sm bg-gray-200 rounded-lg border focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-300 dark:border-gray-600 dark:placeholder-black text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Pókemon..." required />
                    <button onClick={handleSubmit} type="submit" className="block text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buscar</button>
                </div>
            </form>
